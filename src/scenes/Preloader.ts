...
export default class Preloader extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.atlas(
      "lizard_idle",
      "enemies/lizard_idle.png",
      "enemies/lizard_idle.json",
    )
    this.load.atlas(
      "lizard_run",
    ...
    this.load.atlas(
      ...
      "npcs/cat/cat_swinging_tail.json",
    )
    this.load.atlas(
      "cat_licking",
      "npcs/cat/cat_licking.png",
      "npcs/cat/cat_licking.json",
    )
    this.load.atlas(
      "cat_cleaning_head",
      "npcs/cat/cat_cleaning_head.png",
      "npcs/cat/cat_cleaning_head.json",
    )
    this.load.atlas(
      "cat_walking",
      "npcs/cat/cat_walking.png",
      "npcs/cat/cat_walking.json",
    )
    ...
    this.load.audio(SoundEffects.ARROW, [
